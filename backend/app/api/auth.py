...
async def get_public_config(response: Response, db: AsyncSession = Depends(get_db)):
    ...
    if not config:
        ...
        data = {
            ...
            "dark_logo_url": getattr(config, "dark_logo_url", None) or extra_gen.get("darkLogoUrl") or None,
            "footer_logo_url": extra_gen.get("footerLogoUrl") or None,
            "footer_dark_logo_url": getattr(config, "footer_dark_logo_url", None) or extra_gen.get("footerDarkLogoUrl") or None,
