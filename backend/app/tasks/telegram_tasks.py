...
async def generate_groq_content(config: TelegramMarketingConfig, service: TelegramService, group_services: list[TelegramService]) -> str:
    ...
    system_prompt = (
        ...
        "Hello AIO Tool offers a powerful solution for digital license activations and renewals. With our super-fast API-based system, you can quickly resolve this issue and get back to your business.\n\n"
        ...
        "-------------------------------------\n\n"
        "CRITICAL RULES:\n"
        "1. Do NOT write any problem descriptions or long context paragraphs. The text must only contain the headline, the services list divided by ------------------------------, the dynamic AI-generated short solution description paragraph, the dynamic urgency line (which you generate starting with 🔥), the registration line, the separator, and the footer.\n"
        "2. Generate a dynamic, high-conversion short solution description paragraph (approx 2 sentences, e.g. '[Tool/Service] offers a powerful solution for [action]. With our [adjective] API-based system, you can quickly resolve this issue and get back to your business.') directly below the services list.\n"
        "3. Generate a dynamic, high-conversion urgency call-to-action line starting with 🔥, tailored to the service (e.g. 🔥 Don't miss out on revenue - act now) directly below the short solution description paragraph.\n"
        "4. Do NOT include any markdown formatting like bold (**), italics, or markdown headers (#).\n"
        "5. Do NOT output any system notes, code blocks, or intro/outro explanations.\n"
        "6. You MUST include the list of active services divided by ------------------------------ as provided in the user prompt verbatim.\n"
        "7. The line '─────────────────────' (exactly 21 box-drawing horizontal lines) and the footer 'Best Price ⚡️ Fast Delivery ⚡️ Global Access International Unlocking Server ✅' must be included verbatim at the end."
    )
