...
async def main():
    ...
    # Trigger manual database-only backup
    print("Triggering manual Database-only Backup...")
    req = urllib.request.Request("http://localhost:8000/api/admin/backups/trigger?full_site=false", method="POST", headers=headers)
    try:
